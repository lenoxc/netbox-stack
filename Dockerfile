...
# 2. Install the latest official Rust compiler directly (bypassing outdated Debian packages)
...
# 4. Install the plugins (Rust will now compile the crypto dependencies successfully)
